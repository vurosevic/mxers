 ...
 * @author Vladimir
 */
public class LazyDataModelBerza extends LazyDataModel<Berza>{
    
    private List<Berza> datasource;

    public LazyDataModelBerza(List<Berza> datasource) {
        this.datasource = datasource;
    }

    @Override
    public Berza getRowData(String rowKey) {
        for(Berza gz : datasource) {
    ...
    @Override
    public Object getRowKey(Berza object) {
        return object.getId();
    }    
        
    @Override
    public List<Berza> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String, Object> filters) {        
        List<Berza> data = new ArrayList<Berza>();
   //filter
        for(Berza ps : datasource) {
            boolean match = true;
