 ...
 * @author Vladimir
 */
public class LazyDataModelKonkurencija extends LazyDataModel<Konkurencija> {
    private List<Konkurencija> datasource;

    public LazyDataModelKonkurencija(List<Konkurencija> datasource) {
        this.datasource = datasource;
    }

    @Override
    public Konkurencija getRowData(String rowKey) {
        for(Konkurencija gz : datasource) {
    ...
    @Override
    public Object getRowKey(Konkurencija object) {
        return object.getId();
    }    
        
    @Override
    public List<Konkurencija> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String, Object> filters) {        
        List<Konkurencija> data = new ArrayList<Konkurencija>();
   //filter
        for(Konkurencija ps : datasource) {
            boolean match = true;
                    ...
                    try {
                        ...
                        Object filterValue = filters.get(filterProperty);
                           ...
                           if (filterProperty.indexOf('.') > 0) {
                            ...
                            field = Konkurencija.class.getDeclaredField(filterProperty);                                
